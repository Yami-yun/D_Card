...
function EmergencyCallMainPage(){
    ...
    console.log("#######################################TEST###################################");
    console.log("#######################################TEST###################################");
    console.log(emergencyCallDataListContext[2*2+1]);
    console.log("#######################################TEST###################################");
    console.log("#######################################TEST###################################");
    return(
        <>
            ...
            <Whole>
                ...
                {emergencyCallDataListContext.length !== 0 && <EmergencyCallLayout {...emergencyCallDataListContext[2*pagingDataContext.EMERGENCY_CALL_MAIN]} />}
